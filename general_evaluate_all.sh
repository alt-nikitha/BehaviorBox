...
# Configuration
DATA_PATH="/data/user_data/nsrikant/bbox_data/data/mmlu.jsonl"
FEATURES_DIR="/data/user_data/nsrikant/bbox_data/output/mmlu"
...
echo "================================================"
echo "Starting General Evaluation for ${#MODEL_NAMES[@]} models"
echo "================================================"
echo ""
